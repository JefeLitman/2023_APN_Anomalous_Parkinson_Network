"""This file contains the discriminator network used in GANomaly net translated to 3D in Tensorflow.
...
def get_discriminator(x, isize, nc, ngf, extra_layers):
    """Function that return the Discriminator model for GANomaly model translated 
    in tensorflow.
    Args:
