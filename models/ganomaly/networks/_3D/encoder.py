"""This file contains the encoder network used in GANomaly net translated to 3D in Tensorflow.
...
def get_encoder(x, isize, nz, nc, ndf, n_extra_layers=0, encoder_id=0, add_final_conv=True):
    """Function that add and forward the layers of Encoder for GANomaly model translated 
    in tensorflow. This method return two variables, the classifier output and 
    Args:
