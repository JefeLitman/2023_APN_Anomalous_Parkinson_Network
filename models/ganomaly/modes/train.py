"""This file contains the loop for train mode for GANomaly model.
...
from ..utils.steps import train_step
...
def exec_loop(opts, readme_template, kfold, TP, TN, FP, FN, AUC, gen_loss, disc_loss, train_data):
    """This function execute the loop for training of each epoch for GANomaly model. It doesn't return anything but it will be showing the results obtained in each epoch.
    Args:
