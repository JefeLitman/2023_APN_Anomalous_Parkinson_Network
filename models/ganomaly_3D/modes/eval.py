...
def exec_loop(opts, TP, TN, FP, FN, AUC, train_data, test_data):
    ...
    if opts["eval_train"]:
        for step, xyi in enumerate(train_data):
            ...
            acc, pre, rec, spe, f1, auc = get_metrics(0, step, metric_save_path, xyi, opts['normal_class'], latent_i, latent_o, TP, TN, FP, FN, AUC)
